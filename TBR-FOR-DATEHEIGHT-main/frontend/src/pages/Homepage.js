...
const Homepage = () => {
  ...
  const stats = [
    ...
    { label: 'Compliance Rate', value: '99.8%', icon: CheckCircle2 },
    { label: 'Years Experience', value: '15+', icon: TrendingUp },
    { label: 'Services', value: '25+', icon: FileCheck },
  ];
      ...
      <section className="py-16 bg-slate-50 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 items-center opacity-60">
            <span className="text-lg font-bold text-slate-500 tracking-wide text-center">OY &amp; CO.</span>
            <span className="text-lg font-bold text-slate-500 tracking-wide text-center">Dateheight Integrated Nigeria LTD</span>
            <span className="text-lg font-bold text-slate-500 tracking-wide text-center">Oasis Zing Nigeria LTD</span>
            <span className="text-lg font-bold text-slate-500 tracking-wide text-center">REVCON Nigeria LTD</span>
            <span className="text-lg font-bold text-slate-500 tracking-wide text-center">FirstComers Integrated Nigeria LTD</span>
          </div>
        </div>
      </section>
