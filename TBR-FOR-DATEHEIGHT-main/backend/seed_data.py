...
async def seed_database():
    ...
    await db.resources.insert_many([
            {"id": str(uuid.uuid4()),
             "title": "Nigeria Reforms Tax Laws for 2026, Rewrites Rules for MNEs",
             "slug": "nigeria-reforms-tax-laws-2026-mnes",
             "category": "Tax",
             "excerpt": "Nigeria has enacted sweeping changes to its tax framework for 2026, rewriting the rules for multinational enterprises and reshaping how cross-border income is taxed.",
             "content": "Nigeria's 2026 tax reforms introduce a fundamentally rewritten set of rules for multinational enterprises operating in the country. The legislation alters permanent establishment definitions, adjusts withholding tax rates on cross-border payments, and introduces new compliance obligations for groups with Nigerian subsidiaries. Companies with cross-border structures should review their Nigerian exposure immediately and adjust transfer pricing documentation ahead of the new filing season.",
             "author": "TBR Editorial",
             "tags": ["tax reform", "MNE", "Nigeria Tax Act 2026", "withholding tax", "transfer pricing"],
             "featured_image": "", "published": True,
             "source_name": "Bloomberg Tax",
             "source_url": "https://news.bloombergtax.com/tax-management-international/nigeria-reforms-tax-laws-for-2026-rewrites-rules-for-mnes",
             "read_label": "Read on Bloomberg Tax",
             "views": 0, "created_at": now},

            {"id": str(uuid.uuid4()),
             "title": "How Nigeria's 2026 Tax Reform Targets the Gig Economy",
             "slug": "nigeria-2026-tax-reform-gig-economy",
             "category": "Tax",
             "excerpt": "New provisions bring freelance and gig workers into the formal tax net, with simplified registration and withholding mechanisms.",
             "content": "Nigeria's 2026 tax reform specifically addresses the growing gig and freelance economy. The new framework introduces simplified registration pathways for independent contractors, mandates withholding on platform payments above certain thresholds, and creates a low-rate presumptive tax regime for digital economy workers. Freelancers and platforms operating in Nigeria should review their tax obligations under the new rules before the next compliance deadline.",
             "author": "TBR Editorial",
             "tags": ["gig economy", "tax reform", "freelancers", "digital economy", "PAYE"],
             "featured_image": "", "published": True,
             "source_name": "BusinessDay NG",
             "source_url": "https://businessday.ng/news/article/how-nigerias-2026-tax-reform-targets-the-gig-economy/",
             "read_label": "Read on BusinessDay",
             "views": 0, "created_at": now},

            {"id": str(uuid.uuid4()),
             "title": "2026 Business Outlook on Tax Reforms in Nigeria and Ghana",
             "slug": "2026-tax-reforms-nigeria-ghana-ey",
             "category": "Tax",
             "excerpt": "EY's regional outlook maps the legislative and administrative changes shaping West African tax compliance in 2026.",
             "content": "EY's 2026 West Africa tax outlook analyses the wave of legislative changes in Nigeria and Ghana, including new rates, expanded treaty networks and digital tax compliance mandates. For businesses operating across both jurisdictions, the outlook highlights the need for coordinated tax planning and updated transfer pricing policies. The report is essential reading for CFOs and tax directors managing West African operations.",
             "author": "TBR Editorial",
             "tags": ["West Africa", "tax outlook", "EY", "Nigeria", "Ghana", "2026"],
             "featured_image": "", "published": True,
             "source_name": "EY Tax News",
             "source_url": "https://taxnews.ey.com/news/2026-0208-west-africa-from-legislation-to-action-2026-business-outlook-on-tax-reforms-in-nigeria-and-ghana",
             "read_label": "Read on EY",
             "views": 0, "created_at": now},

            {"id": str(uuid.uuid4()),
             "title": "Nigeria — Corporate Significant Developments",
             "slug": "nigeria-corporate-significant-developments-pwc",
             "category": "Business",
             "excerpt": "PwC's summary of Nigeria's most significant corporate tax developments, covering the new Tax Act and its implications for companies.",
             "content": "PwC's corporate tax summary tracks the significant legislative and regulatory developments affecting Nigerian companies. The 2025–2026 period brought the Nigeria Tax Act, changes to education tax rates, updated CAC filing requirements and new digital compliance mandates. This summary is a practical reference for corporate tax teams tracking what has changed and what still needs to be addressed.",
             "author": "TBR Editorial",
             "tags": ["corporate tax", "Nigeria Tax Act", "PwC", "compliance", "developments"],
             "featured_image": "", "published": True,
             "source_name": "PwC Tax Summaries",
             "source_url": "https://taxsummaries.pwc.com/nigeria/corporate/significant-developments",
             "read_label": "Read on PwC",
             "views": 0, "created_at": now},

            {"id": str(uuid.uuid4()),
             "title": "What Businesses Need to Know About the 2026 Tax Filing Changes",
             "slug": "2026-tax-filing-compliance-changes",
             "category": "Tax",
             "excerpt": "Five key compliance changes in Nigeria's 2026 tax filing rules that every business must prepare for.",
             "content": "Nigeria's 2026 tax filing landscape introduces five major compliance changes: new deadlines for CIT and VAT returns, mandatory electronic filing for all categories of taxpayers, revised penalties for late filing, expanded scope for withholding tax collection, and updated requirements for tax clearance certificates. Businesses should update their compliance calendars and ensure their systems are configured for the new e-filing requirements well before the first affected deadline.",
             "author": "TBR Editorial",
             "tags": ["tax filing", "compliance", "deadlines", "e-filing", "penalties"],
             "featured_image": "", "published": True,
             "source_name": "Nigeria Housing Market",
             "source_url": "https://www.nigeriahousingmarket.com/news/2026-tax-filing-five-key-compliance-changes-businesses-must-prepare-for",
             "read_label": "Read article",
             "views": 0, "created_at": now},

            {"id": str(uuid.uuid4()),
             "title": "Revenue Assurance: A Strategic Imperative",
             "slug": "revenue-assurance-strategic-imperative-pwc",
             "category": "Revenue Assurance",
             "excerpt": "PwC makes the case that revenue assurance is no longer optional — it is a board-level strategic function.",
             "content": "In today's complex business landscape, revenue assurance has moved from an IT function to a strategic imperative. PwC's publication outlines how organizations can reduce revenue leakage through improved data quality, automated reconciliation, and continuous monitoring frameworks. For Nigerian businesses facing e-invoicing mandates and real-time tax reporting, the principles in this guide are directly applicable to both tax compliance and financial integrity.",
             "author": "TBR Editorial",
             "tags": ["revenue assurance", "PwC", "leakage", "reconciliation", "strategy"],
             "featured_image": "", "published": True,
             "source_name": "PwC",
             "source_url": "https://www.pwc.com/m1/en/publications/revenue-assurance-strategic-imperative-in-todays-complex-business-landscape.html",
             "read_label": "Read on PwC",
             "views": 0, "created_at": now},

            {"id": str(uuid.uuid4()),
             "title": "What Is Revenue Assurance in Telecom?",
             "slug": "revenue-assurance-telecom-latro",
             "category": "Revenue Assurance",
             "excerpt": "LATRO explains how revenue assurance prevents revenue leakage in telecom and how the same principles apply to tax compliance.",
             "content": "Revenue assurance in telecom is the practice of ensuring that every unit of service delivered is accurately rated, billed and collected. LATRO breaks down the core processes — data mediation, rating verification, reconciliation and fraud detection — that prevent revenue leakage. These same principles are directly relevant to Nigerian businesses managing VAT collections, withholding tax deductions and e-invoice reconciliation under the new tax framework.",
             "author": "TBR Editorial",
             "tags": ["revenue assurance", "telecom", "LATRO", "leakage", "reconciliation"],
             "featured_image": "", "published": True,
             "source_name": "LATRO",
             "source_url": "https://latro.com/blog/stop-revenue-leakage-what-is-revenue-assurance-in-telecom/",
             "read_label": "Read on LATRO",
             "views": 0, "created_at": now},

            {"id": str(uuid.uuid4()),
             "title": "Revenue Assurance Overview",
             "slug": "revenue-assurance-overview-wikipedia",
             "category": "Revenue Assurance",
             "excerpt": "Wikipedia's overview of revenue assurance — the processes, tools and frameworks that protect revenue streams across industries.",
             "content": "Revenue assurance is a set of business processes and management tools designed to ensure that revenue is correctly captured, recorded and collected. The Wikipedia overview covers the origins of revenue assurance in telecom, its expansion into other sectors, and the core techniques including automated reconciliation, data analytics and continuous monitoring. Understanding these foundations helps businesses apply revenue assurance principles to tax compliance and financial reporting.",
             "author": "TBR Editorial",
             "tags": ["revenue assurance", "overview", "reconciliation", "monitoring"],
             "featured_image": "", "published": True,
             "source_name": "Wikipedia",
             "source_url": "https://en.wikipedia.org/wiki/Revenue_assurance",
             "read_label": "Read on Wikipedia",
             "views": 0, "created_at": now},

            {"id": str(uuid.uuid4()),
             "title": "Nigeria's Foreign Investor Surge: A Guide to Opportunities",
             "slug": "nigeria-foreign-investor-surge-kudicompass",
             "category": "Investment",
             "excerpt": "A practical guide to the sectors and structures attracting the most foreign investment into Nigeria in 2026.",
             "content": "Nigeria is experiencing a surge in foreign investor participation driven by recent policy reforms, exchange rate adjustments and sector-specific incentives. KudiCompass maps the key opportunities across technology, energy, agriculture and financial services, with practical guidance on entry structures, regulatory requirements and tax implications. Foreign investors and their advisors should use this guide alongside updated transfer pricing and withholding tax guidance to structure investments efficiently.",
             "author": "TBR Editorial",
             "tags": ["foreign investment", "Nigeria", "FDI", "opportunities", "entry structures"],
             "featured_image": "", "published": True,
             "source_name": "KudiCompass",
             "source_url": "https://kudicompass.com/nigeria-foreign-investor-participation-surge-guide/",
             "read_label": "Read on KudiCompass",
             "views": 0, "created_at": now},

            {"id": str(uuid.uuid4()),
             "title": "Top 5 Investment Opportunities in Nigeria: 2026 Data-Driven",
             "slug": "top-5-investment-opportunities-nigeria-2026",
             "category": "Investment",
             "excerpt": "MOHAC Africa's data-driven breakdown of the five highest-potential investment sectors in Nigeria for 2026.",
             "content": "Using 2026 macroeconomic data and sector analysis, MOHAC Africa identifies the five most promising investment opportunities in Nigeria. The report covers renewable energy, fintech infrastructure, healthcare, agriculture and real estate, providing data on returns, risk profiles and regulatory requirements for each sector. Investors should cross-reference these opportunities with the latest tax incentive provisions under the Nigeria Tax Act 2025 to maximise returns.",
             "author": "TBR Editorial",
             "tags": ["investment", "Nigeria", "2026", "sectors", "data-driven", "MOHAC"],
             "featured_image": "", "published": True,
             "source_name": "MOHAC Africa",
             "source_url": "https://mohacafrica.org/investment-opportunities-in-nigeria/",
             "read_label": "Read on MOHAC Africa",
             "views": 0, "created_at": now},

            {"id": str(uuid.uuid4()),
             "title": "UK Pledges to Partner Nigeria for Predictable Business Environment",
             "slug": "uk-nigeria-predictable-business-environment-allafrica",
             "category": "Business",
             "excerpt": "The UK commits to supporting Nigeria's business environment reforms, signalling stronger bilateral trade and regulatory cooperation.",
             "content": "The UK has pledged to deepen its partnership with Nigeria to create a more predictable and transparent business environment. The commitment covers regulatory harmonisation, tax treaty updates, and investment facilitation between the two countries. For businesses with UK-Nigeria cross-border operations, the announcement signals potential changes to withholding tax rates, double taxation treaty terms and trade facilitation frameworks that should be monitored closely.",
             "author": "TBR Editorial",
             "tags": ["UK", "Nigeria", "bilateral", "business environment", "trade"],
             "featured_image": "", "published": True,
             "source_name": "AllAfrica",
             "source_url": "https://allafrica.com/stories/202603310026.html",
             "read_label": "Read on AllAfrica",
             "views": 0, "created_at": now},
        ])
    print("[OK] Re-seeded 11 curated resources")
